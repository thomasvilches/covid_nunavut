...
v1 = [1;map(y->170+y,0:20)]#;map(y->168+y,0:19)]
v2 = [1.0;map(y->1.0-(0.59/21)*y,1:21)]#;map(y->1.0-(0.599/20)*y,1:20)]
...
v1 = [1;map(y->106+y,0:12)] ##72 112 0,3
v2 = [0.695;map(k->0.695-k*(0.28/13),1:13)]
run_param_scen_cal(0.075,0.67,[1],[999],999,999,v2,999,71,1.5,(1.5*1.3),2,[82],999,1,250)
...
v1 = [1;map(y->106+y,0:12)] ##72 112 0,3
v2 = [0.695;map(k->0.695-k*(0.28/13),1:13)]
run_param_scen_cal(0.075,0.67,[1],[999],999,999,v2,v1,71,1.5,(1.5*1.3),2,[82],999,1,250,"fast2")

v1 = [1;map(y->170+y,0:20)]#;map(y->168+y,0:19)]
v2 = [1.0;map(y->1.0-(0.59/21)*y,1:21)]#;map(y->1.0-(0.599/20)*y,1:20)]
run_param_scen_cal(0.075,1.0,[1],[999],999,999,v2,v1,71,1.5,(1.5*1.3),3,[999],161,2,250,"fast2")
